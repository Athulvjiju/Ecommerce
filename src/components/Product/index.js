...
const Product = () => {
    ...
    if (!Object.keys(product).length > 0) <div>Loading...</div>
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex justify-between items-center">
                            ...
                            <div className='flex'>
                                ...
                                <button className="flex ml-auto border border-indigo-500  py-2 px-6  hover:bg-indigo-600 hover:text-white rounded" onClick={() => handleCart(product)}>Add to Cart</button>
                            </div>
